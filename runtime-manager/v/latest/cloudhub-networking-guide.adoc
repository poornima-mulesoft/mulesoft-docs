...
If you need to whitelist the IPs for the communication between the Mule Agent and the Runtime Manager console, see link:/mule-agent/v/1.4.0/installing-mule-agent#ips-to-whitelist[IPs to Whitelist].
